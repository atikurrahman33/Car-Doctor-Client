    ...
    return (
        ...
        flex items-center justify-center">
                    ...
                    <div className="w-full h-100">
                        ...
                        <form onSubmit={handleSignUp}  className="mt-6" action="#" method="POST">
                            <div>
              ...
              px-4 py-3 mt-6">Sig Up</button>
                        ...
                        <p className="mt-8">Already have a account? <Link to={'/login'}><a href="#" className="text-blue-500 hover:text-blue-700 font-semibold">Login</a></Link></p>
